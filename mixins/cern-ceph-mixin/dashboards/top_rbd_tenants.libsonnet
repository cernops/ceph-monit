    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.piePanel(
          |||
            sum by(tenant_name) (
              openstack_cinder_volume{tenant_id=~"$topcombinedbytes"} *
                on(image) group_left
                  sum by (image) (
      ...
      .addPanel(
        ...
        $.piePanel(
          |||
            sum by(tenant_name) (
              openstack_cinder_volume{tenant_id=~"$topcombinediops"} *
                on(image) group_left
                  sum by (image) (
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.queryPanel(
          |||
            sum by(tenant_name) (
              openstack_cinder_volume{tenant_id=~"$topreadbytes"} *
                on(image) group_left
                  rate(ceph_rbd_read_bytes{cluster=~"$cluster", pool=~"$pool"}[$__rate_interval])
            )
          |||, '{{tenant_name}}', unit='binBps'
      ...
      .addPanel(
        ...
        $.queryPanel(
          |||
            sum by(tenant_name) (
              openstack_cinder_volume{tenant_id=~"$topwritebytes"} *
                on(image) group_left
                  rate(ceph_rbd_write_bytes{cluster=~"$cluster", pool=~"$pool"}[$__rate_interval])
            )
          |||, '{{tenant_name}}', unit='binBps'
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.queryPanel(
          |||
            sum by(tenant_name) (
              openstack_cinder_volume{tenant_id=~"$topreadiops"} *
                on(image) group_left
                  rate(ceph_rbd_read_ops{cluster=~"$cluster", pool=~"$pool"}[$__rate_interval])
            )
          |||, '{{tenant_name}}', unit='iops'
      ...
      .addPanel(
        ...
        $.queryPanel(
          |||
            sum by(tenant_name) (
              openstack_cinder_volume{tenant_id=~"$topwriteiops"} *
                on(image) group_left
                  rate(ceph_rbd_write_ops{cluster=~"$cluster", pool=~"$pool"}[$__rate_interval])
            )
          |||, '{{tenant_name}}', unit='iops'
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.queryPanel(
          |||
            sum by(tenant_name) (
              openstack_cinder_volume{tenant_id=~"$topreadlatency"} *
                on(image) group_left
      ...
      .addPanel(
        ...
        $.queryPanel(
          |||
            sum by(tenant_name) (
              openstack_cinder_volume{tenant_id=~"$topwritelatency"} *
                on(image) group_left
